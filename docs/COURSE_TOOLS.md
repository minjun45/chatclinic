...
> [!IMPORTANT]
> **Revision history**
> - **March 2026 update:** Tool manifests should now describe CPU/GPU runtime behavior explicitly, and image tools may target DICOM or raster inputs such as PNG/JPG/TIFF.
